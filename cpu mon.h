			...
			if (menu != 2) {
				...
				if (taskStatusArray) {
					...
					for (UBaseType_t i = 0; i < taskCount; i++) {
						...
						if (strcmp(taskStatusArray[i].pcTaskName, "IDLE0") == 0) cpuUsage0 = 100.0f - taskCpuUsage;
						if (strcmp(taskStatusArray[i].pcTaskName, "IDLE1") == 0) cpuUsage1 = 100.0f - taskCpuUsage;
					}
